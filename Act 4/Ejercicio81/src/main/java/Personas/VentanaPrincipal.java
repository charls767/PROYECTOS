...
public class VentanaPrincipal extends JFrame implements ActionListener {
    ...
    public VentanaPrincipal() {
        ...
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); // El botón de cerrar permitirá salir de la aplicación
    ...
    private void inicio() {
        ...
        telefono.setBounds(20, 80, 135, 23); // Establece la posición de la etiqueta teléfono
        campoTelefono = new JTextField();
        campoTelefono.setBounds(105, 80, 135, 23); // Establece la posición del campo de texto teléfono

        // Establece la etiqueta y el campo dirección
        direccion = new JLabel("Dirección:");
        direccion.setBounds(20, 110, 135, 23); // Establece la posición de la etiqueta dirección
        campoDireccion = new JTextField();
        campoDireccion.setBounds(105, 110, 135, 23); // Establece la posición del campo de texto dirección
        ...
        listaNombres.setSelectionMode(ListSelectionModel.SINGLE_SELECTION); // Se puede seleccionar solamente un elemento de la lista
